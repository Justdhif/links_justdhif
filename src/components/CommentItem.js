...
const CommentItem = ({ comment = {}, index = 0 }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-gray-900/60 backdrop-blur-lg p-4 rounded-lg flex items-start mb-3 last:mb-0 gap-3 border border-gray-700/50 shadow-md hover:shadow-purple-500/30 transition-all"
    >
      {/* Gambar Profil */}
      <motion.div
        initial={{ scale: 0 }}
